...
if ("serviceWorker" in navigator) {
  window.addEventListener("load", () => {
    navigator.serviceWorker
      .register("sw.js", { updateViaCache: "none" }) // ne jamais mettre sw.js lui-même en cache HTTP
      .then((reg) => reg.update()) // vérifie immédiatement s'il existe une nouvelle version
      .catch(() => {/* offline-first still works via cache */});
  });
